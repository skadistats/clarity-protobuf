...
public class EmbeddedPackets {
    ...
    static {
        ...
        /*   5 */ EMBED.put(NetworkBaseTypes.NET_Messages.net_StringCmd_VALUE, NetworkBaseTypes.CNETMsg_StringCmd.class);
        ...
        /*  28 */ EMBED.put(S1NetMessages.SVC_Messages.svc_Prefetch_VALUE, S1NetMessages.CSVCMsg_Prefetch.class);
        ...
        /* 100 */ EMBED.put(NetworkBaseTypes.NET_Messages.net_PlayerAvatarData_VALUE, NetworkBaseTypes.CNETMsg_PlayerAvatarData.class);
    }
