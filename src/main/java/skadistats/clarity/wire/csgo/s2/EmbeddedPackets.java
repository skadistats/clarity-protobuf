...
public class EmbeddedPackets {
    ...
    static {
        ...
        /* 145 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ParticleManager_VALUE, DemoUserMessages.CUserMsg_ParticleManager.class);
        ...
        /* 301 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VGUIMenu_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VGUIMenu.class);
        /* 302 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Geiger_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Geiger.class);
        /* 303 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Train_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Train.class);
        /* 304 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_HudText_VALUE, CSGOCommonUserMessages.CCSUsrMsg_HudText.class);
...
//      /* 307 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_TextMsg_VALUE, S2UserMessages.CUserMessageTextMsg.class);
        /* 308 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_HudMsg_VALUE, CSGOCommonUserMessages.CCSUsrMsg_HudMsg.class);
        /* 309 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ResetHud_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ResetHud.class);
        /* 310 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_GameTitle_VALUE, CSGOCommonUserMessages.CCSUsrMsg_GameTitle.class);
        /* 312 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Shake_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Shake.class);
        /* 313 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Fade_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Fade.class);
        /* 314 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Rumble_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Rumble.class);
        /* 315 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_CloseCaption_VALUE, CSGOCommonUserMessages.CCSUsrMsg_CloseCaption.class);
        /* 316 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_CloseCaptionDirect_VALUE, CSGOCommonUserMessages.CCSUsrMsg_CloseCaptionDirect.class);
        /* 317 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SendAudio_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SendAudio.class);
        /* 318 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_RawAudio_VALUE, CSGOCommonUserMessages.CCSUsrMsg_RawAudio.class);
        /* 319 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VoiceMask_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VoiceMask.class);
        /* 320 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_RequestState_VALUE, CSGOCommonUserMessages.CCSUsrMsg_RequestState.class);
        /* 321 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_Damage_VALUE, CSGOCommonUserMessages.CCSUsrMsg_Damage.class);
        /* 322 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_RadioText_VALUE, CSGOCommonUserMessages.CCSUsrMsg_RadioText.class);
        /* 323 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_HintText_VALUE, CSGOCommonUserMessages.CCSUsrMsg_HintText.class);
        /* 324 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_KeyHintText_VALUE, CSGOCommonUserMessages.CCSUsrMsg_KeyHintText.class);
        /* 325 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ProcessSpottedEntityUpdate_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ProcessSpottedEntityUpdate.class);
        /* 326 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ReloadEffect_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ReloadEffect.class);
        /* 327 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_AdjustMoney_VALUE, CSGOCommonUserMessages.CCSUsrMsg_AdjustMoney.class);
//      /* 328 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_UpdateTeamMoney_VALUE, CSGOCommonUserMessages.CCSUsrMsg_UpdateTeamMoney.class);
        /* 329 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_StopSpectatorMode_VALUE, CSGOCommonUserMessages.CCSUsrMsg_StopSpectatorMode.class);
        /* 330 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_KillCam_VALUE, CSGOCommonUserMessages.CCSUsrMsg_KillCam.class);
        /* 331 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_DesiredTimescale_VALUE, CSGOCommonUserMessages.CCSUsrMsg_DesiredTimescale.class);
        /* 332 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_CurrentTimescale_VALUE, CSGOCommonUserMessages.CCSUsrMsg_CurrentTimescale.class);
        /* 333 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_AchievementEvent_VALUE, CSGOCommonUserMessages.CCSUsrMsg_AchievementEvent.class);
        /* 334 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_MatchEndConditions_VALUE, CSGOCommonUserMessages.CCSUsrMsg_MatchEndConditions.class);
        /* 335 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_DisconnectToLobby_VALUE, CSGOCommonUserMessages.CCSUsrMsg_DisconnectToLobby.class);
        /* 336 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_PlayerStatsUpdate_VALUE, CSGOCommonUserMessages.CCSUsrMsg_PlayerStatsUpdate.class);
        /* 338 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_WarmupHasEnded_VALUE, CSGOCommonUserMessages.CCSUsrMsg_WarmupHasEnded.class);
        /* 339 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ClientInfo_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ClientInfo.class);
        /* 340 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_XRankGet_VALUE, CSGOCommonUserMessages.CCSUsrMsg_XRankGet.class);
        /* 341 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_XRankUpd_VALUE, CSGOCommonUserMessages.CCSUsrMsg_XRankUpd.class);
        /* 345 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_CallVoteFailed_VALUE, CSGOCommonUserMessages.CCSUsrMsg_CallVoteFailed.class);
        /* 346 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VoteStart_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VoteStart.class);
        /* 347 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VotePass_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VotePass.class);
        /* 348 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VoteFailed_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VoteFailed.class);
        /* 349 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_VoteSetup_VALUE, CSGOCommonUserMessages.CCSUsrMsg_VoteSetup.class);
        /* 350 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ServerRankRevealAll_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ServerRankRevealAll.class);
        /* 351 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SendLastKillerDamageToClient_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SendLastKillerDamageToClient.class);
        /* 352 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ServerRankUpdate_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ServerRankUpdate.class);
        /* 353 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ItemPickup_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ItemPickup.class);
        /* 354 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ShowMenu_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ShowMenu.class);
        /* 355 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_BarTime_VALUE, CSGOCommonUserMessages.CCSUsrMsg_BarTime.class);
        /* 356 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_AmmoDenied_VALUE, CSGOCommonUserMessages.CCSUsrMsg_AmmoDenied.class);
        /* 357 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_MarkAchievement_VALUE, CSGOCommonUserMessages.CCSUsrMsg_MarkAchievement.class);
        /* 358 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_MatchStatsUpdate_VALUE, CSGOCommonUserMessages.CCSUsrMsg_MatchStatsUpdate.class);
        /* 359 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ItemDrop_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ItemDrop.class);
        /* 360 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_GlowPropTurnOff_VALUE, CSGOCommonUserMessages.CCSUsrMsg_GlowPropTurnOff.class);
        /* 361 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SendPlayerItemDrops_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SendPlayerItemDrops.class);
        /* 362 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_RoundBackupFilenames_VALUE, CSGOCommonUserMessages.CCSUsrMsg_RoundBackupFilenames.class);
        /* 363 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SendPlayerItemFound_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SendPlayerItemFound.class);
        /* 364 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ReportHit_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ReportHit.class);
        /* 365 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_XpUpdate_VALUE, CSGOCommonUserMessages.CCSUsrMsg_XpUpdate.class);
        /* 366 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_QuestProgress_VALUE, CSGOCommonUserMessages.CCSUsrMsg_QuestProgress.class);
        /* 367 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_ScoreLeaderboardData_VALUE, CSGOCommonUserMessages.CCSUsrMsg_ScoreLeaderboardData.class);
        /* 368 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_PlayerDecalDigitalSignature_VALUE, CSGOCommonUserMessages.CCSUsrMsg_PlayerDecalDigitalSignature.class);
        /* 369 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_WeaponSound_VALUE, CSGOCommonUserMessages.CCSUsrMsg_WeaponSound.class);
        /* 370 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_UpdateScreenHealthBar_VALUE, CSGOCommonUserMessages.CCSUsrMsg_UpdateScreenHealthBar.class);
        /* 371 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_EntityOutlineHighlight_VALUE, CSGOCommonUserMessages.CCSUsrMsg_EntityOutlineHighlight.class);
        /* 372 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SSUI_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SSUI.class);
        /* 373 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SurvivalStats_VALUE, CSGOCommonUserMessages.CCSUsrMsg_SurvivalStats.class);
//      /* 374 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_DisconnectToLobby2_VALUE, CSGOCommonUserMessages.CCSUsrMsg_DisconnectToLobby2.class);
        /* 375 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_EndOfMatchAllPlayersData_VALUE, CSGOCommonUserMessages.CCSUsrMsg_EndOfMatchAllPlayersData.class);
        /* 376 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_PostRoundDamageReport_VALUE, CSGOCommonUserMessages.CCSUsrMsg_PostRoundDamageReport.class);
        /* 379 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_RoundEndReportData_VALUE, CSGOCommonUserMessages.CCSUsrMsg_RoundEndReportData.class);
        /* 380 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_CurrentRoundOdds_VALUE, CSGOCommonUserMessages.CCSUsrMsg_CurrentRoundOdds.class);
