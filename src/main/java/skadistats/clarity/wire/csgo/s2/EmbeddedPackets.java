...
public class EmbeddedPackets {
    ...
    static {
        ...
        /*  13 */ K2C.put(NetworkBaseTypes.NET_Messages.net_SpawnGroup_LoadCompleted_VALUE, NetworkBaseTypes.CNETMsg_SpawnGroup_LoadCompleted.class);

        /*  40 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_ServerInfo_VALUE, NetMessages.CSVCMsg_ServerInfo.class);
        /*  41 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_FlattenedSerializer_VALUE, S2NetMessages.CSVCMsg_FlattenedSerializer.class);
        /*  42 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_ClassInfo_VALUE, NetMessages.CSVCMsg_ClassInfo.class);
        /*  44 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_CreateStringTable_VALUE, S2NetMessages.CSVCMsg_CreateStringTable.class);
        /*  45 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_UpdateStringTable_VALUE, NetMessages.CSVCMsg_UpdateStringTable.class);
        /*  46 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_VoiceInit_VALUE, NetMessages.CSVCMsg_VoiceInit.class);
        /*  47 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_VoiceData_VALUE, S2NetMessages.CSVCMsg_VoiceData.class);
        /*  48 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_Print_VALUE, NetMessages.CSVCMsg_Print.class);
        /*  50 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_SetView_VALUE, NetMessages.CSVCMsg_SetView.class);
        /*  51 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_ClearAllStringTables_VALUE, S2NetMessages.CSVCMsg_ClearAllStringTables.class);
        /*  55 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_PacketEntities_VALUE, NetMessages.CSVCMsg_PacketEntities.class);
        ...
        /*  70 */ K2C.put(CSGOS2MessageId.SVC_Messages.svc_FullFrameSplit_VALUE, NetMessages.CSVCMsg_FullFrameSplit.class);

        /* 101 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_AchievementEvent_VALUE, CSGOS2UserMessages.CUserMessageAchievementEvent.class);
        /* 102 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CloseCaption_VALUE, CSGOS2UserMessages.CUserMessageCloseCaption.class);
        /* 103 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CloseCaptionDirect_VALUE, CSGOS2UserMessages.CUserMessageCloseCaptionDirect.class);
        /* 104 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CurrentTimescale_VALUE, CSGOS2UserMessages.CUserMessageCurrentTimescale.class);
        /* 105 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_DesiredTimescale_VALUE, CSGOS2UserMessages.CUserMessageDesiredTimescale.class);
        /* 106 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_Fade_VALUE, CSGOS2UserMessages.CUserMessageFade.class);
        /* 107 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_GameTitle_VALUE, CSGOS2UserMessages.CUserMessageGameTitle.class);
        /* 110 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_HudMsg_VALUE, CSGOS2UserMessages.CUserMessageHudMsg.class);
        /* 111 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_HudText_VALUE, CSGOS2UserMessages.CUserMessageHudText.class);
        /* 113 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ColoredText_VALUE, CSGOS2UserMessages.CUserMessageColoredText.class);
        /* 115 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ResetHUD_VALUE, CSGOS2UserMessages.CUserMessageResetHUD.class);
        /* 116 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_Rumble_VALUE, CSGOS2UserMessages.CUserMessageRumble.class);
        /* 117 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_SayText_VALUE, CSGOS2UserMessages.CUserMessageSayText.class);
        /* 118 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_SayText2_VALUE, CSGOS2UserMessages.CUserMessageSayText2.class);
        /* 119 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_SayTextChannel_VALUE, CSGOS2UserMessages.CUserMessageSayTextChannel.class);
        /* 120 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_Shake_VALUE, CSGOS2UserMessages.CUserMessageShake.class);
        /* 121 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ShakeDir_VALUE, CSGOS2UserMessages.CUserMessageShakeDir.class);
        /* 124 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_TextMsg_VALUE, CSGOS2UserMessages.CUserMessageTextMsg.class);
        /* 125 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ScreenTilt_VALUE, CSGOS2UserMessages.CUserMessageScreenTilt.class);
        /* 128 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_VoiceMask_VALUE, CSGOS2UserMessages.CUserMessageVoiceMask.class);
        /* 130 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_SendAudio_VALUE, CSGOS2UserMessages.CUserMessageSendAudio.class);
        /* 131 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ItemPickup_VALUE, CSGOS2UserMessages.CUserMessageItemPickup.class);
        /* 132 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_AmmoDenied_VALUE, CSGOS2UserMessages.CUserMessageAmmoDenied.class);
        /* 134 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ShowMenu_VALUE, CSGOS2UserMessages.CUserMessageShowMenu.class);
        /* 135 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CreditsMsg_VALUE, CSGOS2UserMessages.CUserMessageCreditsMsg.class);
        /* 138 */ // TODO: seen in replay, no enum or protobuf definition
        /* 142 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CloseCaptionPlaceholder_VALUE, CSGOS2UserMessages.CUserMessageCloseCaptionPlaceholder.class);
        /* 143 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CameraTransition_VALUE, CSGOS2UserMessages.CUserMessageCameraTransition.class);
        /* 144 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_AudioParameter_VALUE, CSGOS2UserMessages.CUserMessageAudioParameter.class);
        /* 145 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_ParticleManager_VALUE, CSGOS2UserMessages.CUserMsg_ParticleManager.class);
        /* 146 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_HudError_VALUE, CSGOS2UserMessages.CUserMsg_HudError.class);
        /* 148 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CustomGameEvent_VALUE, CSGOS2UserMessages.CUserMsg_CustomGameEvent.class);
        /* 149 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_AnimGraphUpdate_VALUE, CSGOS2UserMessages.CUserMessageAnimStateGraphState.class);
        /* 150 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_HapticsManagerPulse_VALUE, CSGOS2UserMessages.CUserMessageHapticsManagerPulse.class);
        /* 151 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_HapticsManagerEffect_VALUE, CSGOS2UserMessages.CUserMessageHapticsManagerEffect.class);
        /* 152 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_CommandQueueState_VALUE, CSGOS2UserMessages.CUserMessageCommandQueueState.class);
        /* 153 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_UpdateCssClasses_VALUE, CSGOS2UserMessages.CUserMessageUpdateCssClasses.class);
        /* 155 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_LagCompensationError_VALUE, CSGOS2UserMessages.CUserMessageLagCompensationError.class);
        /* 156 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_RequestDllStatus_VALUE, CSGOS2UserMessages.CUserMessageRequestDllStatus.class);
        /* 157 */ K2C.put(CSGOS2MessageId.EBaseUserMessages.UM_RequestUtilAction_VALUE, CSGOS2UserMessages.CUserMessageRequestUtilAction.class);
...
//      /* 305 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SayText_VALUE, CSGOS2UserMessages.CUserMessageSayText.class);
//      /* 306 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_SayText2_VALUE, CSGOS2UserMessages.CUserMessageSayText2.class);
//      /* 307 */ K2C.put(CSGOS2MessageId.ECstrike15UserMessages.CS_UM_TextMsg_VALUE, CSGOS2UserMessages.CUserMessageTextMsg.class);
