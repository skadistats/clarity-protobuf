package skadistats.clarity.wire.shared.demo;
...
public class DemoPackets {
    ...
    static {
        K2C = new KindToClassMessageRegistry(19);
        ...
        K2C.put(Demo.EDemoCommands.DEM_Recovery_VALUE, Demo.CDemoRecovery.class);
    }
