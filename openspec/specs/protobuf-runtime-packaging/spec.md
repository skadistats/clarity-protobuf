# protobuf-runtime-packaging Specification

## Purpose

TBD: created by syncing the `relocate-protobuf-package` change. Defines how the vendored protobuf runtime is packaged so it coexists with stock `protobuf-java` and never occupies the `com.google.protobuf` package.
